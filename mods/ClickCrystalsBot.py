...
> - `crash`""")
      ...
      if params[1] in ["wiki","ccs"]:
         await message.channel.send(f"""> {message.author.mention} Here is the full wiki for clickcrystals script!
...
Need pre-made scripts? https://itzispyder.github.io/ccs
